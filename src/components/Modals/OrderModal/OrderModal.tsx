        ...
        >
            <div className={`${Style.OrderWrapper}`}>
                <div className={`${Style.OrderWrapper_numberWrapper} mb-15`}>
                    <h2 className={`${Style.OrderWrapper_numberWrapper_number} text_type_digits-large mb-8`}>
                        {"0".repeat(6 - data.order.number.toString().length) + data.order.number}
                    </h2>
                ...
                <div className={`${Style.OrderWrapper_hints}`}>
                    <div className={`${Style.OrderWrapper_hints_hint} text_type_main-default mb-2`}>Ваш заказ начали
                        готовить
                    </div>
                    <div
                        className={`${Style.OrderWrapper_hints_hint} text_type_main-default text_color_inactive`}>Дождитесь
                        готовности на орбитальной станции
                    </div>
                </div>
            </div>
        </ModalContainer>
